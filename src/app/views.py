...
def selectComp(request):
    ...
    company_name = request.POST.get('compNames', "0001061768")
    ...
    #new_model = tf.keras.models.load_model("Users/Usuario/Desktop/Latest_Codes/GitHub/SVM/saved_model/my_model")
    #prediction = new_model.predict()

    

    context = {'company_name':company_name, 'totalCount':totalCount, 'names':names, 'values':values, 'stock_prices':stock_prices, 'time':time, "fund":fund, "income_statement":income_st}
    return render(request, 'index.html', context)
